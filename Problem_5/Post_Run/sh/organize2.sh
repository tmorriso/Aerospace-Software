...
# Problem 5
#
# Description: This bash scipt unzips a tar file and sorts the contents into sub# directories according to there extension type. It then zips the new directory structure into a new zip labeled _clean
#
# Run with command  . ./organize2.sh ZIPfile
#
################################################################################
